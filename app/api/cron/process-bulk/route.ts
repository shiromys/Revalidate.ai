...
* DNS resolver for MX record checking
...
* Disposable domains from environment
...
* Process a single email for validation
...
async function processEmail(
  ...
  try {
    ...
    // BASIC mode: syntax + MX check only
    ...
    // ADVANCED mode: call backend for SMTP validation
